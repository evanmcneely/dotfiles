return {
  {
    ...
    --stylua: ignore
    keys = {
      { "<leader>ea", function() require("harpoon.mark").add_file() end, desc = "Harpoon Add File" },
      { "<leader>em", function() require("harpoon.ui").toggle_quick_menu() end, desc = "Harpoon File Menu" },
